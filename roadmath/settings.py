"""
Django settings for roadmath project.
...
ALLOWED_HOSTS = ['roadmath.herokuapp.com', 'localhost', '127.0.0.1']
...
WSGI_APPLICATION = 'roadmath.wsgi.application'


# Database
# https://docs.djangoproject.com/en/4.0/ref/settings/#databases

DATABASES = {'default' : env.dj_db_url('DATABASE_URL')} #if DEBUG else {
    #'default': {
